"""
HTTP MCP Server for {WORKFLOW_NAME}
...
app = FastAPI(
    title="{WORKFLOW_NAME} MCP Server",
...
async def root():
    ...
    return {{
        "status": "ok",
        "service": "{WORKFLOW_NAME} MCP Server",
        "version": "1.0.0"
    }}
...
def main():
    ...
    parser = argparse.ArgumentParser(description="HTTP MCP Server for {WORKFLOW_NAME}")
    parser.add_argument(
        "--port",
        type=int,
        default=8080,
